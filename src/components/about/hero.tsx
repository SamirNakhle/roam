...
export const Hero = ({ title, description, buttons }: HeroProps) => {
  return (
    <div className="mb-[100px] flex flex-col items-center py-[51px] text-center text-white">
      <h1 className="mx-auto pb-[22px] text-[26px] font-black sm:max-w-[720px] sm:text-[68px] sm:leading-[78px] lg:text-[72px] lg:leading-[78px]">
        {title}
      </h1>
      <p className="mx-auto pb-[72px] text-[18px] font-light sm:max-w-[720px] sm:text-[24px]">
        {description}
      </p>
      <div className="flex items-center justify-center gap-[25px] self-stretch sm:flex-row sm:flex-wrap sm:gap-[50px]">
